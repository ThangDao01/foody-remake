!function (e) {
  ...
  var s = function (e, t, i, a, s, n, r, l) {
    var h, o = 'function' == typeof e ? e.options : e;
    if (t && (o.render = t, o.staticRenderFns = i, o._compiled = !0), a && (o.functional = !0), n && (o._scopeId = 'data-v-' + n), r ? (h = function (e) {
    ...
    }, o._ssrRegister = h) : s && (h = l ? function () {
    ...
    created: function () {
      this.typeaheadTags = this.cloneArray(this.existingTags), this.tagsFromValue(), this.typeaheadAlwaysShow && this.searchTag(!1)
    },
    mounted: function () {
      var e = this;
      this.$emit('initialized'), document.addEventListener('click', (function (t) {
    ...
    watch: {
      input: function (e, t) {
        if (this.searchTag(!1), e.length && e != t) {
          ...
          this.addTagsOnSpace && e.endsWith(' ') && (this.input = e.trim(), this.tagFromInput(!0)), this.addTagsOnComma && (e = e.trim()).endsWith(',') && (this.input = e.substring(0, e.length - 1), this.tagFromInput(!0)), this.$emit('change', e)
        }
      },
      existingTags: function (e) {
        this.typeaheadTags.splice(0), this.typeaheadTags = this.cloneArray(e), this.searchTag()
      },
      tags: function () {
    ...
    methods: {
        ...
        if (!this.composing) {
          if (this.searchResults.length && this.searchSelection >= 0 && !e) {
            ...
            if (!this.onlyExistingTags && t.length && this.validate(t)) {
              var i;
              this.input = '';
              var s = (a(i = {}, this.idField, ''), a(i, this.textField, t), i),
                n = this.escapeRegExp(this.caseSensitiveTags ? s[this.textField] : s[this.textField].toLowerCase()),
                r = !0, l = !1, h = void 0;
              try {
                for (var o, u = this.typeaheadTags[Symbol.iterator](); !(r = (o = u.next()).done); r = !0) {
                  var d = o.value,
                    c = this.escapeRegExp(this.caseSensitiveTags ? d[this.textField] : d[this.textField].toLowerCase());
                  if (n === c) {
                    s = Object.assign({}, d);
                    break
                  }
      ...
      tagFromSearch: function (e) {
        var t = this;
        this.clearSearchResults(), this.addTag(e), this.$nextTick((function () {
          t.input = '', t.oldInput = ''
        }))
      },
      addTag: function (e) {
        ...
        if (!this.disabled || i) {
          return !!this.beforeAddingTag(e) && (this.limit > 0 && this.tags.length >= this.limit ? (this.$emit('limit-reached'), !1) : void (this.tagSelected(e) || (this.tags.push(e), this.$nextTick((function () {
      ...
      removeTag: function (e) {
        ...
        if (!this.disabled) {
          var i = this.tags[e];
          if (!this.beforeRemovingTag(i)) {
            return !1;
          }
          this.tags.splice(e, 1), this.$nextTick((function () {
            t.$emit('tag-removed', i), t.$emit('tags-updated'), t.typeaheadAlwaysShow && t.searchTag()
          }))
        }
      },
      searchTag: function () {
        ...
        if (this.oldInput != this.input || !this.searchResults.length && 0 == this.typeaheadActivationThreshold || this.typeaheadAlwaysShow || this.typeaheadShowOnFocus) {
          this.typeaheadUrl.length || this.typeaheadCallback || (this.searchResults = []), this.searchSelection = 0;
          var t = this.input.trim();
          if (t.length && t.length >= this.typeaheadActivationThreshold || 0 == this.typeaheadActivationThreshold || this.typeaheadAlwaysShow) {
            var i = this.escapeRegExp(this.caseSensitiveTags ? t : t.toLowerCase());
            if (this.typeaheadCallback) {
              ...
              var a = new XMLHttpRequest, s = this;
              a.onreadystatechange = function () {
                4 == this.readyState && 200 == this.status && (s.typeaheadTags = JSON.parse(a.responseText), s.doSearch(i))
              };
              var n = this.typeaheadUrl.replace(':search', i);
      ...
      doSearch: function (e) {
        ...
        try {
          for (var n, r = this.typeaheadTags[Symbol.iterator](); !(i = (n = r.next()).done); i = !0) {
            var l = n.value, h = this.caseSensitiveTags ? l[this.textField] : l[this.textField].toLowerCase(),
              o = this.searchResults.map((function (e) {
                return e[t.idField]
              }));
            h.search(e) > -1 && !this.tagSelected(l) && !o.includes(l[this.idField]) && this.searchResults.push(l)
          }
        } catch (e) {
          a = !0, s = e
        } finally {
        ...
        this.sortSearchResults && this.searchResults.sort((function (e, i) {
          return e[t.textField] < i[t.textField] ? -1 : e[t.textField] > i[t.textField] ? 1 : 0
        })), this.typeaheadMaxResults > 0 && (this.searchResults = this.searchResults.slice(0, this.typeaheadMaxResults))
      },
      hideTypeahead: function () {
        var e = this;
        this.input.length || this.$nextTick((function () {
      ...
      clearSearchResults: function () {
        ...
        this.searchResults = [], this.searchSelection = 0, this.typeaheadAlwaysShow && this.$nextTick((function () {
          e.searchTag()
      ...
      tagsFromValue: function () {
        if (this.value && this.value.length) {
          if (!Array.isArray(this.value)) {
            return void console.error('Voerro Tags Input: the v-model value must be an array!');
          }
          var e = this.value;
          if (this.tags == e) {
            return;
          ...
          try {
            for (var s, n = e[Symbol.iterator](); !(t = (s = n.next()).done); t = !0) {
              var r = s.value;
              this.addTag(r, !0)
            }
          } catch (e) {
      ...
      tagSelected: function (e) {
        ...
        var t = this.escapeRegExp(this.caseSensitiveTags ? e[this.textField] : e[this.textField].toLowerCase()), i = !0,
          a = !1, s = void 0;
        try {
          for (var n, r = this.tags[Symbol.iterator](); !(i = (n = r.next()).done); i = !0) {
            var l = n.value, h = this.caseSensitiveTags ? l[this.textField] : l[this.textField].toLowerCase();
            if (l[this.idField] === e[this.idField] && this.escapeRegExp(h).length == t.length && h.search(t) > -1) {
              return !0
            }
          }
        } catch (e) {
      ...
      hiddenInputValue: function (e) {
        ...
        return 1 === t.length ? e[t[0]] : JSON.stringify(Object.assign.apply(Object, [{}].concat(function (e) {
          if (Array.isArray(e)) {
      ...
      getDisplayField: function (e) {
        return void 0 !== this.displayField && null !== this.displayField && void 0 !== e[this.displayField] && null !== e[this.displayField] && '' !== e[this.displayField] ? e[this.displayField] : e[this.textField]
      },
    ...
    }, [a('div', {class: (e = {}, e[t.wrapperClass + ' tags-input'] = !0, e.active = t.isActive, e.disabled = t.disabled, e)}, [t._l(t.tags, (function (e, i) {
      return a('span', {
        key: i,
        staticClass: 'tags-input-badge tags-input-badge-pill tags-input-badge-selected-default',
        class: {disabled: t.disabled}
      }, [t._t('selected-tag', [a('span', {domProps: {innerHTML: t._s(e[t.textField])}}), t._v(' '), a('a', {
        directives: [{
          name: 'show',
          rawName: 'v-show',
          value: !t.disabled,
    ...
    }), t._v(' '), t.elementId ? a('div', {staticStyle: {display: 'none'}}, t._l(t.tags, (function (e, i) {
      return a('input', {
        key: i,
        attrs: {
          type: 'hidden',
    ...
    }, ['badges' === t.typeaheadStyle ? a('p', {class: 'typeahead-' + t.typeaheadStyle}, [t.typeaheadHideDiscard ? t._e() : a('span', {
    ...
    }), t._v(' '), t._l(t.searchResults, (function (e, i) {
      return a('span', {
        key: i,
        staticClass: 'tags-input-badge',
        class: {
          'tags-input-typeahead-item-default': i != t.searchSelection,
          'tags-input-typeahead-item-highlighted-default': i == t.searchSelection
        },
        ...
        on: {
          ...
          mousedown: function (i) {
            return i.preventDefault(), t.tagFromSearchOnClick(e)
          }
        }
      })
    }))], 2) : 'dropdown' === t.typeaheadStyle ? a('ul', {class: 'typeahead-' + t.typeaheadStyle}, [t.typeaheadHideDiscard ? t._e() : a('li', {
