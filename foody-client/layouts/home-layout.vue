  ...
  <div class="body">
          ...
          <div class="input-group col-md-4 col-sm-12 m-0 p-0">
            <div class="input-search form-inline col-12 p-0  flex-nowrap">
              <input id="form1"
                     ...
                     placeholder="Địa điểm, món ăn, loại hình ..." v-model="searchValue" v-on:change="getRestaurantSearch()"/>
    ...
    <div class="tool p-0" id="tool" style="display: none">
      <ul class="p-0 m-0">
        ...
        <li class="tool-item" data-toggle="tooltip" data-placement="left" title="Tải ứng dụng" v-for="download in config.link_download">
          <a :href="download.link_action"><i :class="'fa ' +download.fa_icon"></i></a>
        </li>
      </ul>
    </div>
    <div class="slide">
...
export default {
  ...
  methods: {
    ...
    async getConfig() {
      ...
      this.config.link_download = JSON.parse(this.config.link_download)
    ...
    async getRestaurantSearch() {
      this.ListRestaurantSearch = await this.$axios.$post('/restaurant-search', {
